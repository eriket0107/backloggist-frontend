...
import { CaptionsOff, ChevronLeft, ChevronRight, ImageIcon } from "lucide-react";
...
export const ItemsTable = memo(
  ({
    ...
    const handleNextPage = useCallback(() => {
      ...
      onNextPage?.();
    }, [isLastPage, isFetching, onNextPage]);
          ...
          <Card className="p-x-6! p-4">
                  ...
                  items.map((item, index) => (
                    ...
                    >
                      ...
                      <TableCell className="py-4">
                        <Badge
                          className={cn("text-white font-bold", getTypeColor(item.type))}
                        >
                          {getType[item.type]}
                        </Badge>
                      </TableCell>
            ...
            {!items.length && (
              <div className="h-[450px] flex flex-col items-center justify-center">
                <CaptionsOff className="text-gray-400" height={50} width={50} />
